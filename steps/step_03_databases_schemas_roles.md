...
Open your `02_DATA_GENERATION` worksheet and run the following. The transactions table generates approximately 500,000 rows -- this step takes approximately 60 seconds.
